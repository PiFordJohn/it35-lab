import { 
  ...
  const Home: React.FC = () => {
    ...
    const tabs = [
      ...
      {name:'Favorites', tab:'favorites',url: '/it35-final/app/home/favorites', icon: star},
    ...
    return (
      <IonReactRouter>
        ...
        <IonRouterOutlet>
          ...
          <Route exact path="/it35-final/app/home/search" render={Search} />
          <Route exact path="/it35-final/app/home/favorites" render={Favorites} />
